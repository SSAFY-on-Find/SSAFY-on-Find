...
INSERT IGNORE INTO students (student_id, name, major_yn, team_id, class_code, created_by, created_at)
VALUES (1300001, '김서준', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300002, '이하윤', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300003, '박지호', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300004, '최서아', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300005, '정은우', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300006, '강지안', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300007, '조유준', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300008, '윤하은', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300009, '장시우', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300010, '임수아', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300011, '한도윤', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300012, '오채원', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300013, '서예준', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300014, '신유나', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300015, '권민준', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300016, '황다은', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300017, '안주원', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300018, '송지우', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300019, '유하준', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300020, '전서윤', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300021, '정서아', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300022, '강지안', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300023, '최은우', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300024, '김하윤', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300025, '이시우', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300026, '박서준', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300027, '조지호', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300028, '윤수아', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300029, '장유준', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300030, '임채원', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300031, '한민준', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300032, '오유나', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300033, '서하준', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300034, '신지우', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300035, '권도윤', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300036, '황서윤', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300037, '안예준', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300038, '송다은', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300039, '유주원', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300040, '전하은', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300041, '오지호', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300042, '한서아', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300043, '임은우', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300044, '장하윤', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300045, '윤서준', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300046, '조지안', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300047, '강시우', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300048, '정수아', FALSE, NULL, 'CLS001', '0001234', NOW()),
       (1300049, '최유준', TRUE, NULL, 'CLS001', '0001234', NOW()),
       (1300050, '박채원', FALSE, NULL, 'CLS001', '0001234', NOW());